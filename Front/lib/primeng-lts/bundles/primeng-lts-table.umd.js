(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('primeng-lts/api'), require('primeng-lts/paginator'), require('primeng-lts/dom'), require('primeng-lts/utils'), require('rxjs'), require('@angular/cdk/scrolling')) :
    typeof define === 'function' && define.amd ? define('primeng-lts/table', ['exports', '@angular/core', '@angular/common', 'primeng-lts/api', 'primeng-lts/paginator', 'primeng-lts/dom', 'primeng-lts/utils', 'rxjs', '@angular/cdk/scrolling'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global['primeng-lts'] = global['primeng-lts'] || {}, global['primeng-lts'].table = {}), global.ng.core, global.ng.common, global['primeng-lts'].api, global['primeng-lts'].paginator, global['primeng-lts'].dom, global['primeng-lts'].utils, global.rxjs, global.ng.cdk.scrolling));
