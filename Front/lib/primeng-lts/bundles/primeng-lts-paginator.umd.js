(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/forms'), require('primeng-lts/dropdown'), require('primeng-lts/ripple'), require('primeng-lts/api')) :
    typeof define === 'function' && define.amd ? define('primeng-lts/paginator', ['exports', '@angular/core', '@angular/common', '@angular/forms', 'primeng-lts/dropdown', 'primeng-lts/ripple', 'primeng-lts/api'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global['primeng-lts'] = global['primeng-lts'] || {}, global['primeng-lts'].paginator = {}), global.ng.core, global.ng.common, global.ng.forms, global['primeng-lts'].dropdown, global['primeng-lts'].ripple, global['primeng-lts'].api));
