(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('primeng-lts/api'), require('primeng-lts/utils'), require('primeng-lts/dom'), require('primeng-lts/ripple')) :
    typeof define === 'function' && define.amd ? define('primeng-lts/galleria', ['exports', '@angular/core', '@angular/common', 'primeng-lts/api', 'primeng-lts/utils', 'primeng-lts/dom', 'primeng-lts/ripple'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global['primeng-lts'] = global['primeng-lts'] || {}, global['primeng-lts'].galleria = {}), global.ng.core, global.ng.common, global['primeng-lts'].api, global['primeng-lts'].utils, global['primeng-lts'].dom, global['primeng-lts'].ripple));
