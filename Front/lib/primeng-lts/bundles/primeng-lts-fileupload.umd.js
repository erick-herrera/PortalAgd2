(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/platform-browser'), require('primeng-lts/button'), require('primeng-lts/messages'), require('primeng-lts/progressbar'), require('primeng-lts/dom'), require('primeng-lts/api'), require('primeng-lts/ripple'), require('@angular/common/http')) :
    typeof define === 'function' && define.amd ? define('primeng-lts/fileupload', ['exports', '@angular/core', '@angular/common', '@angular/platform-browser', 'primeng-lts/button', 'primeng-lts/messages', 'primeng-lts/progressbar', 'primeng-lts/dom', 'primeng-lts/api', 'primeng-lts/ripple', '@angular/common/http'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global['primeng-lts'] = global['primeng-lts'] || {}, global['primeng-lts'].fileupload = {}), global.ng.core, global.ng.common, global.ng.platformBrowser, global['primeng-lts'].button, global['primeng-lts'].messages, global['primeng-lts'].progressbar, global['primeng-lts'].dom, global['primeng-lts'].api, global['primeng-lts'].ripple, global.ng.common.http));
