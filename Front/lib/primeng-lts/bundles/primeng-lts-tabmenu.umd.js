(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('primeng-lts/ripple'), require('primeng-lts/api'), require('@angular/router'), require('primeng-lts/dom')) :
    typeof define === 'function' && define.amd ? define('primeng-lts/tabmenu', ['exports', '@angular/core', '@angular/common', 'primeng-lts/ripple', 'primeng-lts/api', '@angular/router', 'primeng-lts/dom'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global['primeng-lts'] = global['primeng-lts'] || {}, global['primeng-lts'].tabmenu = {}), global.ng.core, global.ng.common, global['primeng-lts'].ripple, global['primeng-lts'].api, global.ng.router, global['primeng-lts'].dom));
