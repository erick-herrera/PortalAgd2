(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('primeng-lts/dom'), require('primeng-lts/api'), require('primeng-lts/ripple'), require('@angular/router'), require('rxjs'), require('rxjs/operators')) :
    typeof define === 'function' && define.amd ? define('primeng-lts/contextmenu', ['exports', '@angular/core', '@angular/common', 'primeng-lts/dom', 'primeng-lts/api', 'primeng-lts/ripple', '@angular/router', 'rxjs', 'rxjs/operators'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global['primeng-lts'] = global['primeng-lts'] || {}, global['primeng-lts'].contextmenu = {}), global.ng.core, global.ng.common, global['primeng-lts'].dom, global['primeng-lts'].api, global['primeng-lts'].ripple, global.ng.router, global.rxjs, global.rxjs.operators));
